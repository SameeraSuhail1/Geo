...
syring_bins <- st_read(dsn = "syringe_bins",layer = "geo_export_88d97081-c511-4f9e-ab8d-0af43bbbe67b")
...
table7 <- find_nearest_distance(origAddress_final, codes,syring_bins, col_name =  "syringebin_distance") 
...
#--------------------Linear Regression--------------------------
see_fit1 = lm(Price~tree_distance + light_distance + playg_distance +  Rooms + height
